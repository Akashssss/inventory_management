 ...
 * Body:
 */
export const example1SimpleFilter = {
  filter: {
    field: "status",
    operator: "eq",
    value: "active",
 ...
 * Body:
 */
export const example2PriceRange = {
  filter: {
    field: "price",
    operator: "between",
    value: [500, 1500],
 ...
 * Body:
 */
export const example3ComplexNested = {
  filter: {
    logic: "and",
    conditions: [
      {
 ...
 * Body:
 */
export const example4SearchWithFilter = {
  filter: {
    logic: "and",
    conditions: [
      {
 ...
 * Body:
 */
export const example5DateRange = {
  filter: {
    logic: "and",
    conditions: [
      {
 ...
 * Body:
 */
export const example6TextMatching = {
  filter: {
    logic: "and",
    conditions: [
      {
 ...
 * Body:
 */
export const example7ArrayOperations = {
  filter: {
    logic: "and",
    conditions: [
      {
 ...
 * Body:
 */
export const example8RelativeDates = {
  filter: {
    field: "updatedAt",
 ...
 * Body:
 */
export const example9EmptyChecks = {
  filter: {
    logic: "or",
    conditions: [
      {
 ...
 * Body:
 */
export const example10FieldSelection = {
  filter: {
    field: "status",
    operator: "eq",
    value: "active",
 ...
 * Body:
 */
export const example11Pagination = {
  filter: {
    field: "status",
    operator: "eq",
    value: "active",
 ...
 * Body:
 */
export const example12RealWorld = {
  filter: {
    logic: "and",
    conditions: [
      {
 ...
 */
export const example13ErrorInvalidField = {
  error: {
 ...
 */
export const example13ErrorInvalidOperator = {
  error: {
 ...
 */
export const example13ErrorTooComplex = {
  error: {
    code: "QUERY_TOO_COMPLEX",
    message:
      "Query complexity (125) exceeds maximum allowed (100). Simplify your filters or pagination.",
    statusCode: 429,
    details: {
      complexity: 125,
      maxPermitted: 100,
 ...
 */
export const example13ErrorPermissionDenied = {
  error: {
 ...
 */
export const curl1SimpleFilter = `
 ...
 */
export const curl2ComplexFilter = `
curl -X POST http://localhost:3000/api/products \\
  -H "Content-Type: application/json" \\
  -H "x-tenant-id: tenant-123" \\
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \\
 ...
 */
export const curl3SearchWithFilter = `
curl -X POST http://localhost:3000/api/products \\
  -H "Content-Type: application/json" \\
  -H "x-tenant-id: tenant-123" \\
  -d '{
